...
public class TimedMethod implements Runnable {
	...
	public void run() {
		if (method.equals("teleport"))
			((Player) sender).teleport((Location) objects[0]);
		else if (method.equals("remove cooldown"))
			...
			sender.sendMessage(ChatColor.DARK_RED + "Hey! What the heck does \"" + method + "\" mean? Get REALDrummer over here and tell him to fix this!");
	}
